...
abstract class TarFormats {
  ...
  static const v7 = TarFormatImpl._(1);
  ...
  static const ustar = TarFormatImpl._(2);
  ...
  static const pax = TarFormatImpl._(4);
  ...
  static const gnu = TarFormatImpl._(8);
  ...
  /// Reference:
  /// http://cdrtools.sourceforge.net/private/man/star/star.4.html
  static const star = TarFormatImpl._(16);
}
...
class TarFormatImpl implements TarFormat {
  ...
  const TarFormatImpl._(this.value);
  ...
  TarFormat mayBe(TarFormat? other) {
    if (other == null) {
      ...
      return TarFormatImpl._(value | other.value);
    }
  }

  @override
  TarFormat mayOnlyBe(TarFormat other) => TarFormatImpl._(value & other.value);
